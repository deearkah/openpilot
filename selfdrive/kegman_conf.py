...
class kegman_conf():
  ...
  def read_config(self):
    ...
    if os.path.isfile('/data/kegman.json'):
      ...
      self.config = {"cameraOffset":"0.06", "lastTrMode":"1", "battChargeMin":"45", "battChargeMax":"66", \
                     "wheelTouchSeconds":"600", "accelerationMode":"1","battPercOff":"30", "carVoltageMinEonShutdown":"11800", \
